...
First, let's try `nix-shell -p example`, I have covered this briefly in [the first guide](https://alexanderluo.com/articles/an-introduction-to-nix-and-nixos) and I am going to reuse the example:
```bash
...
+ Based on the comment, do not edit the stateVersion, even if changing channels
